...
|---------------| --------------------------- |---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|------------------------------------------------------------------------------------------|---------------------------------------------------------------------------------------------------------------------------------------------------| ------------------------------------------------------------------------------------------- |
| Carl - 600HP  | Durable front-line fighter  | **Guardian** — when Carl drops below 30% HP, incoming damage against him is reduced by 50% and his attack increased by 20%. He also tanks the hit, if a team member would be downed by an attack. (Once per Fight). | **Roundhouse Kick** — single-target physical attack. — **DMG:** 50-120 (**CD:** 0)       | **Explosive Toss** — stronger multi-target attack with high damage. Hurts the party for 0–30% of the damage dealt. — **DMG:** 150-200 (**CD:** 0) | **Protective Shell** — defensive move that nullifies party damage for one turn. (**CD:** 3) |
...
| Hoarder           | BossEnemy  | **Greedy Bulk** & **Garbage Spawn**                               | **Devour** — ingest all scatterers alive for their remaining HP                    | FINAL_PHASE  | **CD:** 2                  |
| Scatterer - 100HP | TrashEnemy | **NONE**                                                          | **Bug Bite** — weak single-target attack. — **DMG:** 10-30                         | NORMAL       | **CD:** 0                  |
| Scatterer         | TrashEnemy | **NONE**                                                          | **Bug Bite** — weak single-target attack. — **DMG:** 30-50                         | AGGRESSIVE   | **CD:** 0                  |
